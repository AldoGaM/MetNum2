...
def sistema1 (x0, y0, lim, tol):
    ...
    i = 0
    erabs = 100
    # creamos un vector para realizar los productos matriciales con numpy
    X0 = np.array([x0,y0])
    # bandera para el determinante de la matriz
    det = False
    # guardaremos los datos en un arreglo llamado "resultados" para poder imprimirlo más fácil
    resultados = []
